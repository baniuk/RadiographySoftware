#include "StdAfx.h"
#include "C_Command_Sobel.h"

C_Command_Sobel::C_Command_Sobel(void)
{
	UINT parint[2] = {IMAGE,NUMBER};
	UINT parout[1] = {IMAGE};
	InitCommand("sobel",2,1,parint,parout);
	intab = new C_Variables*[numofinparam];
	outtab = new C_Variables*[numofoutparam];
	syntax = "IMAGE = sobel(IMAGE,NUMBER)";
	fun_ver = "1.0";
}
...
void C_Command_Sobel::Do(C_Error& err)
{
