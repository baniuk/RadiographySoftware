#include "StdAfx.h"
#include "C_Command_Prewitt.h"

C_Command_Prewitt::C_Command_Prewitt(void)
{
	UINT parint[2] = {IMAGE,NUMBER};
	UINT parout[1] = {IMAGE};
	InitCommand("prewitt",2,1,parint,parout);
	intab = new C_Variables*[numofinparam];
	outtab = new C_Variables*[numofoutparam];
	syntax = "IMAGE = prewitt(IMAGE,NUMBER)";
	fun_ver = "1.0";
}
...
void C_Command_Prewitt::Do(C_Error& err)
{
